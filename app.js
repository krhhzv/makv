...
function downloadInvoice() { 
    ...
    let printHtml = `
    <div id="print-container" style="font-family: 'Inter', sans-serif; color: var(--text-main); -webkit-print-color-adjust: exact; print-color-adjust: exact; position: relative;">
        <!-- Watermark -->
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); opacity: 0.03; pointer-events: none; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            <svg viewBox="0 0 24 24" width="400" height="400" stroke="currentColor" stroke-width="2" fill="none"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
            <div style="font-size: 100px; font-weight: 800; letter-spacing: -0.05em; margin-top: 20px;">Makv</div>
        </div>
        
        <!-- Header -->
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 60px; border-bottom: 2px solid var(--border-color); padding-bottom: 30px;">
            <div style="display: flex; align-items: center; gap: 16px;">
                <div style="width: 50px; height: 50px; background: var(--primary); color: white; border-radius: 14px; display: flex; align-items: center; justify-content: center;">
                    <svg viewBox="0 0 24 24" width="30" height="30" stroke="currentColor" stroke-width="2" fill="none"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                </div>
                <h1 style="margin: 0; font-size: 32px; font-weight: 800; letter-spacing: -0.03em;">Invoice</h1>
            </div>
            <div style="text-align: right;">
                <div style="color: var(--text-muted); font-size: 14px; font-weight: 600; text-transform: uppercase; margin-bottom: 8px;">Date</div>
                <div style="font-weight: 600; font-size: 18px;">${new Date().toLocaleDateString()}</div>
            </div>
        </div>

        <!-- Billed To -->
        <div style="margin-bottom: 40px;">
            <div style="color: var(--text-muted); font-size: 14px; font-weight: 600; text-transform: uppercase; margin-bottom: 8px;">Billed To</div>
            <div style="font-weight: 700; font-size: 24px;">${mkClient || 'Client Name Not Specified'}</div>
        </div>

        <!-- Items Table -->
        <div style="margin-bottom: 40px;">
            <div style="display: flex; justify-content: space-between; padding: 16px; background: var(--input-bg); border-radius: var(--radius-md); font-weight: 600; color: var(--text-muted); margin-bottom: 16px;">
                <span>Description</span>
                <span>Amount</span>
            </div>
            ${mkItems.map(item => `
                <div style="display: flex; justify-content: space-between; padding: 16px; border-bottom: 1px solid var(--border-color); font-size: 16px; font-weight: 500;">
                    <span>${item.name}</span>
        ...
        <div style="display: flex; justify-content: flex-end;">
            <div style="width: 300px; background: var(--card-bg); padding: 24px; border-radius: var(--radius-lg); border: 2px solid var(--primary-light); display: flex; justify-content: space-between; align-items: center;">
                <span style="font-weight: 600; font-size: 18px; color: var(--text-muted);">Total Due</span>
                <span style="font-weight: 800; font-size: 32px; color: var(--primary);">$${total.toFixed(2)}</span>
            </div>
        </div>
    </div>
    `;
    ...
    setTimeout(() => {
        ...
        if(window.showToast) showToast("Invoice ready");
    }, 100);
}
